...
# Load image
# src_image_path = '../yolov5/img/largeCoordinate.png' 
...
def process_seat_division(psj_lounge_desk):
    psj_lounge_with_chair = chair_area_tl(psj_lounge_desk, 25)
    return psj_lounge_with_chair